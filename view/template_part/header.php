    ...
    <header>
        ...
        <div id="menu">
            ...
            <div id="toggle-container">
                ...
                <ul>
                    <li><a href="/"><img class="icons" src="./public/assets/img/maison.svg" alt=""> Acceuil</a></li>
                    <?php if($_SESSION):?>
                    <li><a href="<?php echo $router->generate('logout'); ?>" class="btn">logout</a></li>
                    <li><a href="<?php echo $router->generate('createpost') ?>" class="btn btn-codoc">Create codoc<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
