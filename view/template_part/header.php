    ...
    <header>
        <div id="menu">
            <nav id="sidebar">
                ...
                <ul>
                    <li>
                        <a href="/"><img class="icons" src="./public/assets/img/maison.svg" alt=""> Acceuil</a>
                    </li>
                    <?php if ($_SESSION): ?>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo $router->generate('createpost') ?>" class="btn btn-codoc">Create codoc
                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 11L11 1M11 1H1M11 1V11" stroke="#101828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        </a>
                    </li>
                    <?php else: ?>
                    <li>
                        <a href="<?php echo $router->generate('login'); ?>"><img class="icons" src="./public/assets/img/utilisateur.svg" alt=""> login</a>
                    </li>
                    <li>
                        <a href="<?php echo $router->generate('login') ?>"><img class="icons" src="./public/assets/img/ajout-dutilisateur.svg" alt=""> Register</a>
                    </li>
                    <?php endif; ?>
                </ul>
            </nav>
